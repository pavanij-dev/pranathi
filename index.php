...
/* styling for arrows on the banner ends here*/
      ...
      <link rel="preload" as="image" href="img/mv-banner1x.webp" imagesrcset="img/banner1.jpg" imagesizes="100vw" fetchpriority="high">
      ...
      <div class="wrapper">
         ...
         <div id="sliderSection" class="carousel slide mt-3" data-bs-ride="carousel">
            <div class="carousel-inner">
               <div class="carousel-item active" data-bs-interval="4000">
                  <picture><source srcset="img/320w/mv-banner1x_320w.webp" media="(max-width: 320px)" type="image/webp"><source srcset="img/640w/mv-banner1x_640w.webp" media="(max-width: 640px)" type="image/webp"><source srcset="img/1024w/mv-banner1x_1024w.webp" media="(max-width: 1024px)" type="image/webp"><source srcset="img/1920w/mv-banner1x_1920w.webp" media="(max-width: 1920px)" type="image/webp"><img class="d-block d-md-none" src="img/mv-banner1x.webp" style="margin-top: 70px;" alt="" fetchpriority="high" loading="lazy" decoding="async"></picture>
                  <picture><source srcset="img/320w/banner1_320w.webp" media="(max-width: 320px)" type="image/webp"><source srcset="img/640w/banner1_640w.webp" media="(max-width: 640px)" type="image/webp"><source srcset="img/1024w/banner1_1024w.webp" media="(max-width: 1024px)" type="image/webp"><source srcset="img/1920w/banner1_1920w.webp" media="(max-width: 1920px)" type="image/webp"><img class="d-none d-md-block" src="img/banner1.webp" style="margin-top: 50px;" alt="" fetchpriority="high" loading="lazy" decoding="async"></picture>
               </div>
               <div class="carousel-item" data-bs-interval="4000">
                  <picture><source srcset="img/320w/mv-banner2x_320w.webp" media="(max-width: 320px)" type="image/webp"><source srcset="img/640w/mv-banner2x_640w.webp" media="(max-width: 640px)" type="image/webp"><source srcset="img/1024w/mv-banner2x_1024w.webp" media="(max-width: 1024px)" type="image/webp"><source srcset="img/1920w/mv-banner2x_1920w.webp" media="(max-width: 1920px)" type="image/webp"><img class="d-block d-md-none" src="img/mv-banner2x.webp" style="margin-top: 70px;" alt="" loading="lazy" decoding="async"></picture>
               ...
               <div class="carousel-item" data-bs-interval="4000">
                  ...
                  <picture><source srcset="img/320w/banner2-webx_320w.webp" media="(max-width: 320px)" type="image/webp"><source srcset="img/640w/banner2-webx_640w.webp" media="(max-width: 640px)" type="image/webp"><source srcset="img/1024w/banner2-webx_1024w.webp" media="(max-width: 1024px)" type="image/webp"><source srcset="img/1920w/banner2-webx_1920w.webp" media="(max-width: 1920px)" type="image/webp"><img class="d-none d-md-block" src="img/banner2-webx.webp" style="margin-top: 50px;" alt="" loading="lazy" decoding="async"></picture>
               </div>
            </div>
               ...
               <div class="row mb-3">
                  <div class="col-lg-12 align-self-center wow fadeInLeft delay-04s">
                     <div class="text">
                        ...
                        <p>Set sail to the future in Hyderabad! Tellapur to the inside of the ORR is a coveted location. Within its green stretches rises the Pranathi Kiara – a plush gated community of apartments spread over 3 stunning blocks. Come home to love and warmth. Shift your focus to the Western corridor of Hyderabad for a new future. Get ready for all things extraordinary at Pranathi Kiara, brings brightness and sunshine to everyday life. Not everyone is like you. Not every destination will be as thoughtful and as love! Not every home can be a Pranathi Kiara.</p>
                     </div>
                  </div>
               </div>
               <div class="row wow fadeInRight delay-04s">
                  ...
                  <div class="col-12 col-md-4">
                     <div class="service-info-2">
                        ...
                        <div class="service-info-2-ditels">
                           <h3><a href="#">Six-Floor Clubhouse</a></h3>
                        </div>
                     </div>
                  </div>
                  <div class="col-12 col-md-4">
                     <div class="service-info-2">
                        <div class="icon">
                           <picture><source srcset="images/icons/project-overview/320w/club-House_320w.webp" media="(max-width: 320px)" type="image/webp"><source srcset="images/icons/project-overview/640w/club-House_640w.webp" media="(max-width: 640px)" type="image/webp"><source srcset="images/icons/project-overview/1024w/club-House_1024w.webp" media="(max-width: 1024px)" type="image/webp"><source srcset="images/icons/project-overview/1920w/club-House_1920w.webp" media="(max-width: 1920px)" type="image/webp"><img src="images/icons/project-overview/club-House.webp" alt="With 20+ Amenities" loading="lazy" decoding="async" width="64" height="64"></picture>
                        </div>
                        <div class="service-info-2-ditels">
                           <h3><a href="#">With 20+ Amenities</a></h3>
                        </div>
                     </div>
                  </div>
                  <div class="col-12 col-md-4">
                           ...
                           <div class="property-thumbnail">
                              <a href="javascript:void(0);" class="property-img">
                                 <div class="property-overflow">
                                    <!-- <img class="d-block w-100" src="images/amenities/Amphitheater-min.webp" alt="properties"> -->
                                    <picture><source srcset="images/amenities/320w/1_320w.webp" media="(max-width: 320px)" type="image/webp"><source srcset="images/amenities/640w/1_640w.webp" media="(max-width: 640px)" type="image/webp"><source srcset="images/amenities/1024w/1_1024w.webp" media="(max-width: 1024px)" type="image/webp"><source srcset="images/amenities/1920w/1_1920w.webp" media="(max-width: 1920px)" type="image/webp"><img class="d-block w-100" src="images/amenities/1.webp" alt="properties" loading="lazy" decoding="async" width="400" height="400"></picture>
                                 </div>
                              </a>
                           </div>
                        </div>
                     ...
                     <div class="cardImage">
                        <div class="property-box">
                           <div class="property-thumbnail">
                              <a href="javascript:void(0);" class="property-img">
                                 <div class="property-overflow">
                                    <!-- <img class="d-block w-100" src="images/amenities/Court.webp" alt="properties"> -->
                                    <picture><source srcset="images/amenities/320w/2_320w.webp" media="(max-width: 320px)" type="image/webp"><source srcset="images/amenities/640w/2_640w.webp" media="(max-width: 640px)" type="image/webp"><source srcset="images/amenities/1024w/2_1024w.webp" media="(max-width: 1024px)" type="image/webp"><source srcset="images/amenities/1920w/2_1920w.webp" media="(max-width: 1920px)" type="image/webp"><img class="d-block w-100" src="images/amenities/2.webp" alt="properties" loading="lazy" decoding="async" width="400" height="400"></picture>
                                 </div>
                              </a>
                           </div>
                        </div>
                     ...
                     <div class="cardImage">
                        <div class="property-box">
                           <div class="property-thumbnail">
                              <a href="javascript:void(0);" class="property-img">
                                 <div class="property-overflow">
                                    <!-- <img class="d-block w-100" src="images/amenities/Club-house-view-1.webp" alt="properties"> -->
                                    <picture><source srcset="images/amenities/320w/3_320w.webp" media="(max-width: 320px)" type="image/webp"><source srcset="images/amenities/640w/3_640w.webp" media="(max-width: 640px)" type="image/webp"><source srcset="images/amenities/1024w/3_1024w.webp" media="(max-width: 1024px)" type="image/webp"><source srcset="images/amenities/1920w/3_1920w.webp" media="(max-width: 1920px)" type="image/webp"><img class="d-block w-100" src="images/amenities/3.webp" alt="properties" loading="lazy" decoding="async" width="400" height="400"></picture>
                                 </div>
                              </a>
                           </div>
                        </div>
                     ...
                     <div class="cardImage">
                        <div class="property-box">
                           <div class="property-thumbnail">
                              <a href="javascript:void(0);" class="property-img">
                                 <div class="property-overflow">
                                    <!-- <img class="d-block w-100" src="images/amenities/Electric-Car.webp" alt="properties"> -->
                                    <picture><source srcset="images/amenities/320w/4_320w.webp" media="(max-width: 320px)" type="image/webp"><source srcset="images/amenities/640w/4_640w.webp" media="(max-width: 640px)" type="image/webp"><source srcset="images/amenities/1024w/4_1024w.webp" media="(max-width: 1024px)" type="image/webp"><source srcset="images/amenities/1920w/4_1920w.webp" media="(max-width: 1920px)" type="image/webp"><img class="d-block w-100" src="images/amenities/4.webp" alt="properties" loading="lazy" decoding="async" width="49" height="28"></picture>
                                 </div>
                              </a>
                           </div>
                        </div>
                     ...
                     <div class="cardImage">
                        <div class="property-box">
                           <div class="property-thumbnail">
                              <a href="javascript:void(0);" class="property-img">
                                 <div class="property-overflow">
                                    <!-- <img class="d-block w-100" src="images/amenities/Gym.webp" alt="properties"> -->
                                    <picture><source srcset="images/amenities/320w/5_320w.webp" media="(max-width: 320px)" type="image/webp"><source srcset="images/amenities/640w/5_640w.webp" media="(max-width: 640px)" type="image/webp"><source srcset="images/amenities/1024w/5_1024w.webp" media="(max-width: 1024px)" type="image/webp"><source srcset="images/amenities/1920w/5_1920w.webp" media="(max-width: 1920px)" type="image/webp"><img class="d-block w-100" src="images/amenities/5.webp" alt="properties" loading="lazy" decoding="async" width="400" height="400"></picture>
                                 </div>
                              </a>
                           </div>
                        </div>
                     ...
                     <div class="cardImage">
                        <div class="property-box">
                           <div class="property-thumbnail">
                              <a href="javascript:void(0);" class="property-img">
                                 <div class="property-overflow">
                                    <!-- <img class="d-block w-100" src="images/amenities/Hall.webp" alt="properties"> -->
                                    <picture><source srcset="images/amenities/320w/6_320w.webp" media="(max-width: 320px)" type="image/webp"><source srcset="images/amenities/640w/6_640w.webp" media="(max-width: 640px)" type="image/webp"><source srcset="images/amenities/1024w/6_1024w.webp" media="(max-width: 1024px)" type="image/webp"><source srcset="images/amenities/1920w/6_1920w.webp" media="(max-width: 1920px)" type="image/webp"><img class="d-block w-100" src="images/amenities/6.webp" alt="properties" loading="lazy" decoding="async" width="400" height="400"></picture>
                                 </div>
                              </a>
                           </div>
                        </div>
                     ...
                     <div class="cardImage">
                        <div class="property-box">
                           <div class="property-thumbnail">
                              <a href="javascript:void(0);" class="property-img">
                                 <div class="property-overflow">
                                    <!-- <img class="d-block w-100" src="images/amenities/Lobby.webp"
                                       alt="properties"> -->
                                       <picture><source srcset="images/amenities/320w/7_320w.webp" media="(max-width: 320px)" type="image/webp"><source srcset="images/amenities/640w/7_640w.webp" media="(max-width: 640px)" type="image/webp"><source srcset="images/amenities/1024w/7_1024w.webp" media="(max-width: 1024px)" type="image/webp"><source srcset="images/amenities/1920w/7_1920w.webp" media="(max-width: 1920px)" type="image/webp"><img class="d-block w-100" src="images/amenities/7.webp" alt="properties" loading="lazy" decoding="async" width="400" height="400"></picture>
                                 </div>
                              </a>
                           </div>
                        </div>
                     ...
                     <div class="cardImage">
                        <div class="property-box">
                           <div class="property-thumbnail">
                              <a href="javascript:void(0);" class="property-img">
                                 <div class="property-overflow">
                                    <!-- <img class="d-block w-100" src="images/amenities/Party-lawn.webp"
                                       alt="properties"> -->
                                       <picture><source srcset="images/amenities/320w/8_320w.webp" media="(max-width: 320px)" type="image/webp"><source srcset="images/amenities/640w/8_640w.webp" media="(max-width: 640px)" type="image/webp"><source srcset="images/amenities/1024w/8_1024w.webp" media="(max-width: 1024px)" type="image/webp"><source srcset="images/amenities/1920w/8_1920w.webp" media="(max-width: 1920px)" type="image/webp"><img class="d-block w-100" src="images/amenities/8.webp" alt="properties" loading="lazy" decoding="async" width="400" height="400"></picture>
                                 </div>
                              </a>
                           </div>
                        </div>
                     ...
                     <div class="cardImage">
                        <div class="property-box">
                           <div class="property-thumbnail">
                              <a href="javascript:void(0);" class="property-img">
                                 <div class="property-overflow">
                                    <!-- <img class="d-block w-100" src="images/amenities/Pool.webp" alt="properties"> -->
                                    <picture><source srcset="images/amenities/320w/9_320w.webp" media="(max-width: 320px)" type="image/webp"><source srcset="images/amenities/640w/9_640w.webp" media="(max-width: 640px)" type="image/webp"><source srcset="images/amenities/1024w/9_1024w.webp" media="(max-width: 1024px)" type="image/webp"><source srcset="images/amenities/1920w/9_1920w.webp" media="(max-width: 1920px)" type="image/webp"><img class="d-block w-100" src="images/amenities/9.webp" alt="properties" loading="lazy" decoding="async" width="400" height="400"></picture>
                                 </div>
                              </a>
                           </div>
                        </div>
                     ...
                     <div class="cardImage">
                        <div class="property-box">
                           <div class="property-thumbnail">
                              <a href="javascript:void(0);" class="property-img">
                                 <div class="property-overflow">
                                    <!-- <img class="d-block w-100" src="images/amenities/Supermarket.webp"
                                       alt="properties"> -->
                                       <picture><source srcset="images/amenities/320w/10_320w.webp" media="(max-width: 320px)" type="image/webp"><source srcset="images/amenities/640w/10_640w.webp" media="(max-width: 640px)" type="image/webp"><source srcset="images/amenities/1024w/10_1024w.webp" media="(max-width: 1024px)" type="image/webp"><source srcset="images/amenities/1920w/10_1920w.webp" media="(max-width: 1920px)" type="image/webp"><img class="d-block w-100" src="images/amenities/10.webp" alt="properties" loading="lazy" decoding="async" width="400" height="400"></picture>
                                 </div>
                              </a>
                           </div>
                        </div>
         ...
         <section class="mt-5">
            <div class="container">
               <div class="row">
                  <div class="main-title-4">
                     <h1>Pranathi Kiara's <span>Near By Locations</span> </h1>
                  </div>
                  <div class="col-12 col-md-4 mb-3">
                     <div class="card">
                        <div class="card-header bg-near-by-location">Nearest Schools</div>
                        <ul class="list-group list-group-flush">
                           <li class="list-group-item">Meru International School - 7 min</li>
                           <li class="list-group-item">Samasthi International School - 10 min</li>
                           <li class="list-group-item">The Gaudium School - 13 min</li>
                           <li class="list-group-item">Manthan International School - 12 min</li>
                           <li class="list-group-item">Chirec international School - 31 min</li>
                           <li class="list-group-item">Future Kids School - 23 min</li>
                           <li class="list-group-item">Oakridge International School - 25 min</li>
                           <li class="list-group-item">DPS, Khajaguda - 26 min</li>
                           <li class="list-group-item">Glendale International School - 13 min</li>
                        </ul>
                     </div>
                  </div>
                  <div class="col-12 col-md-4 mb-3">
                     <div class="card">
                        ...
                        <ul class="list-group list-group-flush">
                           <li class="list-group-item">CA Technologies - 23 min</li>
                           <li class="list-group-item">Hitachi Consulting - 24 min</li>
                           <li class="list-group-item">Kapil Tower - 25 min</li>
                           <li class="list-group-item">Waverock - 27 min</li>
                           <li class="list-group-item">Wipro - 24 min</li>
                           <li class="list-group-item">ICICI Bank - 22 min</li>
                           <li class="list-group-item">TCS Synergy Park - 30 min</li>
                           <li class="list-group-item">Infosys - 27 min</li>
                           <li class="list-group-item">Polaris - 30 min</li>
                        </ul>
                     </div>
                  </div>
                  <div class="col-12 col-md-4 mb-3">
                     <div class="card">
                        ...
                        <ul class="list-group list-group-flush">
                           <li class="list-group-item">Citizen Hospital - 20 min</li>
                           <li class="list-group-item">ESI Hospital - 32 min</li>
                           <li class="list-group-item">Archana Hospital - 28 min</li>
                           <li class="list-group-item">Pranaam Hospital - 31 min</li>
                           <li class="list-group-item">AIG Hospital - 27 min</li>
                           <li class="list-group-item">Care Hospital - 29 min</li>
                           <li class="list-group-item">Continental Hospital - 21 min</li>
                           <li class="list-group-item">Airaavata Hospital - 18 min</li>
                           <li class="list-group-item">Apollo Spectra Hospital - 30 min</li>
                           <!--<li class="list-group-item">Sunshine Hospital - 1 hr</li>-->
                           <!--<li class="list-group-item">Apollo Hospital - 44 min</li>-->
                        </ul>
                     </div>
                  </div>
               </div>
         ...
         <section id="projectSpecifications" class="Kiara-Specification">
            <div class="main-title-4">
               <h1>Pranathi Kiara <span>Specifications</span> </h1>
            </div>
            <div class="container">
               <div class="row">
                  <div class="col-sm-6">
         ...
         <section id="projectGallery" class="gallery-section">
            <div class="main-title-4">
               <h1>PRANATHI KIARA <span>Gallery</span> </h1>
            ...
            <div class="row">
               <ul class="gallery-slider ">
                  <li><a data-fancybox="grp" href="images/gallery/b1x.webp"><picture><source srcset="images/gallery/320w/b1x_320w.webp" media="(max-width: 320px)" type="image/webp"><source srcset="images/gallery/640w/b1x_640w.webp" media="(max-width: 640px)" type="image/webp"><source srcset="images/gallery/1024w/b1x_1024w.webp" media="(max-width: 1024px)" type="image/webp"><source srcset="images/gallery/1920w/b1x_1920w.webp" media="(max-width: 1920px)" type="image/webp"><img src="images/gallery/b1x.webp" alt="" loading="lazy" decoding="async" width="425" height="354"></picture></a></li>
                  <li><a data-fancybox="grp" href="images/gallery/b2x.webp"><picture><source srcset="images/gallery/320w/b2x_320w.webp" media="(max-width: 320px)" type="image/webp"><source srcset="images/gallery/640w/b2x_640w.webp" media="(max-width: 640px)" type="image/webp"><source srcset="images/gallery/1024w/b2x_1024w.webp" media="(max-width: 1024px)" type="image/webp"><source srcset="images/gallery/1920w/b2x_1920w.webp" media="(max-width: 1920px)" type="image/webp"><img src="images/gallery/b2x.webp" alt="" loading="lazy" decoding="async" width="425" height="354"></picture></a></li>
                  <li><a data-fancybox="grp" href="images/gallery/b3x.webp"><picture><source srcset="images/gallery/320w/b3x_320w.webp" media="(max-width: 320px)" type="image/webp"><source srcset="images/gallery/640w/b3x_640w.webp" media="(max-width: 640px)" type="image/webp"><source srcset="images/gallery/1024w/b3x_1024w.webp" media="(max-width: 1024px)" type="image/webp"><source srcset="images/gallery/1920w/b3x_1920w.webp" media="(max-width: 1920px)" type="image/webp"><img src="images/gallery/b3x.webp" alt="" loading="lazy" decoding="async" width="425" height="354"></picture></a></li>
                  <li><a data-fancybox="grp" href="images/gallery/b4x.webp"><picture><source srcset="images/gallery/320w/b4x_320w.webp" media="(max-width: 320px)" type="image/webp"><source srcset="images/gallery/640w/b4x_640w.webp" media="(max-width: 640px)" type="image/webp"><source srcset="images/gallery/1024w/b4x_1024w.webp" media="(max-width: 1024px)" type="image/webp"><source srcset="images/gallery/1920w/b4x_1920w.webp" media="(max-width: 1920px)" type="image/webp"><img src="images/gallery/b4x.webp" alt="" loading="lazy" decoding="async" width="425" height="354"></picture></a></li>
                  <li><a data-fancybox="grp" href="images/gallery/b5x.webp"><picture><source srcset="images/gallery/320w/b5x_320w.webp" media="(max-width: 320px)" type="image/webp"><source srcset="images/gallery/640w/b5x_640w.webp" media="(max-width: 640px)" type="image/webp"><source srcset="images/gallery/1024w/b5x_1024w.webp" media="(max-width: 1024px)" type="image/webp"><source srcset="images/gallery/1920w/b5x_1920w.webp" media="(max-width: 1920px)" type="image/webp"><img src="images/gallery/b5x.webp" alt="" loading="lazy" decoding="async" width="425" height="354"></picture></a></li>
                  <li><a data-fancybox="grp" href="images/gallery/b6x.webp"><picture><source srcset="images/gallery/320w/b6x_320w.webp" media="(max-width: 320px)" type="image/webp"><source srcset="images/gallery/640w/b6x_640w.webp" media="(max-width: 640px)" type="image/webp"><source srcset="images/gallery/1024w/b6x_1024w.webp" media="(max-width: 1024px)" type="image/webp"><source srcset="images/gallery/1920w/b6x_1920w.webp" media="(max-width: 1920px)" type="image/webp"><img src="images/gallery/b6x.webp" alt="" loading="lazy" decoding="async" width="425" height="354"></picture></a></li>
                  <li><a data-fancybox="grp" href="images/gallery/b7x.webp"><picture><source srcset="images/gallery/320w/b7x_320w.webp" media="(max-width: 320px)" type="image/webp"><source srcset="images/gallery/640w/b7x_640w.webp" media="(max-width: 640px)" type="image/webp"><source srcset="images/gallery/1024w/b7x_1024w.webp" media="(max-width: 1024px)" type="image/webp"><source srcset="images/gallery/1920w/b7x_1920w.webp" media="(max-width: 1920px)" type="image/webp"><img src="images/gallery/b7x.webp" alt="" loading="lazy" decoding="async" width="425" height="354"></picture></a></li>
                  <li><a data-fancybox="grp" href="images/gallery/b8x.webp"><picture><source srcset="images/gallery/320w/b8x_320w.webp" media="(max-width: 320px)" type="image/webp"><source srcset="images/gallery/640w/b8x_640w.webp" media="(max-width: 640px)" type="image/webp"><source srcset="images/gallery/1024w/b8x_1024w.webp" media="(max-width: 1024px)" type="image/webp"><source srcset="images/gallery/1920w/b8x_1920w.webp" media="(max-width: 1920px)" type="image/webp"><img src="images/gallery/b8x.webp" alt="" loading="lazy" decoding="async" width="425" height="354"></picture></a></li>
                  <li><a data-fancybox="grp" href="images/gallery/b9x.webp"><picture><source srcset="images/gallery/320w/b9x_320w.webp" media="(max-width: 320px)" type="image/webp"><source srcset="images/gallery/640w/b9x_640w.webp" media="(max-width: 640px)" type="image/webp"><source srcset="images/gallery/1024w/b9x_1024w.webp" media="(max-width: 1024px)" type="image/webp"><source srcset="images/gallery/1920w/b9x_1920w.webp" media="(max-width: 1920px)" type="image/webp"><img src="images/gallery/b9x.webp" alt="" loading="lazy" decoding="async" width="425" height="354"></picture></a></li>
                  <li><a data-fancybox="grp" href="images/gallery/b10x.webp"><picture><source srcset="images/gallery/320w/b10x_320w.webp" media="(max-width: 320px)" type="image/webp"><source srcset="images/gallery/640w/b10x_640w.webp" media="(max-width: 640px)" type="image/webp"><source srcset="images/gallery/1024w/b10x_1024w.webp" media="(max-width: 1024px)" type="image/webp"><source srcset="images/gallery/1920w/b10x_1920w.webp" media="(max-width: 1920px)" type="image/webp"><img src="images/gallery/b10x.webp" alt="" loading="lazy" decoding="async" width="425" height="354"></picture></a></li>
                  <li><a data-fancybox="grp" href="images/gallery/b11x.webp"><picture><source srcset="images/gallery/320w/b11x_320w.webp" media="(max-width: 320px)" type="image/webp"><source srcset="images/gallery/640w/b11x_640w.webp" media="(max-width: 640px)" type="image/webp"><source srcset="images/gallery/1024w/b11x_1024w.webp" media="(max-width: 1024px)" type="image/webp"><source srcset="images/gallery/1920w/b11x_1920w.webp" media="(max-width: 1920px)" type="image/webp"><img src="images/gallery/b11x.webp" alt="" loading="lazy" decoding="async" width="425" height="354"></picture></a></li>
                  <li><a data-fancybox="grp" href="images/gallery/b12x.webp"><picture><source srcset="images/gallery/320w/b12x_320w.webp" media="(max-width: 320px)" type="image/webp"><source srcset="images/gallery/640w/b12x_640w.webp" media="(max-width: 640px)" type="image/webp"><source srcset="images/gallery/1024w/b12x_1024w.webp" media="(max-width: 1024px)" type="image/webp"><source srcset="images/gallery/1920w/b12x_1920w.webp" media="(max-width: 1920px)" type="image/webp"><img src="images/gallery/b12x.webp" alt="" loading="lazy" decoding="async" width="425" height="354"></picture></a></li>
                  <li><a data-fancybox="grp" href="images/gallery/b13x.webp"><picture><source srcset="images/gallery/320w/b13x_320w.webp" media="(max-width: 320px)" type="image/webp"><source srcset="images/gallery/640w/b13x_640w.webp" media="(max-width: 640px)" type="image/webp"><source srcset="images/gallery/1024w/b13x_1024w.webp" media="(max-width: 1024px)" type="image/webp"><source srcset="images/gallery/1920w/b13x_1920w.webp" media="(max-width: 1920px)" type="image/webp"><img src="images/gallery/b13x.webp" alt="" loading="lazy" decoding="async" width="425" height="354"></picture></a></li>
                  <li><a data-fancybox="grp" href="images/gallery/b14x.webp"><picture><source srcset="images/gallery/320w/b14x_320w.webp" media="(max-width: 320px)" type="image/webp"><source srcset="images/gallery/640w/b14x_640w.webp" media="(max-width: 640px)" type="image/webp"><source srcset="images/gallery/1024w/b14x_1024w.webp" media="(max-width: 1024px)" type="image/webp"><source srcset="images/gallery/1920w/b14x_1920w.webp" media="(max-width: 1920px)" type="image/webp"><img src="images/gallery/b14x.webp" alt="" loading="lazy" decoding="async" width="425" height="354"></picture></a></li>
                  <li><a data-fancybox="grp" href="images/gallery/b15x.webp"><picture><source srcset="images/gallery/320w/b15x_320w.webp" media="(max-width: 320px)" type="image/webp"><source srcset="images/gallery/640w/b15x_640w.webp" media="(max-width: 640px)" type="image/webp"><source srcset="images/gallery/1024w/b15x_1024w.webp" media="(max-width: 1024px)" type="image/webp"><source srcset="images/gallery/1920w/b15x_1920w.webp" media="(max-width: 1920px)" type="image/webp"><img src="images/gallery/b15x.webp" alt="" loading="lazy" decoding="async" width="425" height="354"></picture></a></li>
                  <li><a data-fancybox="grp" href="images/gallery/b16x.webp"><picture><source srcset="images/gallery/320w/b16x_320w.webp" media="(max-width: 320px)" type="image/webp"><source srcset="images/gallery/640w/b16x_640w.webp" media="(max-width: 640px)" type="image/webp"><source srcset="images/gallery/1024w/b16x_1024w.webp" media="(max-width: 1024px)" type="image/webp"><source srcset="images/gallery/1920w/b16x_1920w.webp" media="(max-width: 1920px)" type="image/webp"><img src="images/gallery/b16x.webp" alt="" loading="lazy" decoding="async" width="425" height="354"></picture></a></li>
                  <li><a data-fancybox="grp" href="images/gallery/b17x.webp"><picture><source srcset="images/gallery/320w/b17x_320w.webp" media="(max-width: 320px)" type="image/webp"><source srcset="images/gallery/640w/b17x_640w.webp" media="(max-width: 640px)" type="image/webp"><source srcset="images/gallery/1024w/b17x_1024w.webp" media="(max-width: 1024px)" type="image/webp"><source srcset="images/gallery/1920w/b17x_1920w.webp" media="(max-width: 1920px)" type="image/webp"><img src="images/gallery/b17x.webp" alt="" loading="lazy" decoding="async" width="425" height="354"></picture></a></li>
                  <li><a data-fancybox="grp" href="images/gallery/b18x.webp"><picture><source srcset="images/gallery/320w/b18x_320w.webp" media="(max-width: 320px)" type="image/webp"><source srcset="images/gallery/640w/b18x_640w.webp" media="(max-width: 640px)" type="image/webp"><source srcset="images/gallery/1024w/b18x_1024w.webp" media="(max-width: 1024px)" type="image/webp"><source srcset="images/gallery/1920w/b18x_1920w.webp" media="(max-width: 1920px)" type="image/webp"><img src="images/gallery/b18x.webp" alt="" loading="lazy" decoding="async" width="425" height="354"></picture></a></li>
                  <li><a data-fancybox="grp" href="images/gallery/b19x.webp"><picture><source srcset="images/gallery/320w/b19x_320w.webp" media="(max-width: 320px)" type="image/webp"><source srcset="images/gallery/640w/b19x_640w.webp" media="(max-width: 640px)" type="image/webp"><source srcset="images/gallery/1024w/b19x_1024w.webp" media="(max-width: 1024px)" type="image/webp"><source srcset="images/gallery/1920w/b19x_1920w.webp" media="(max-width: 1920px)" type="image/webp"><img src="images/gallery/b19x.webp" alt="" loading="lazy" decoding="async" width="425" height="354"></picture></a></li>
                  <li><a data-fancybox="grp" href="images/gallery/b20x.webp"><picture><source srcset="images/gallery/320w/b20x_320w.webp" media="(max-width: 320px)" type="image/webp"><source srcset="images/gallery/640w/b20x_640w.webp" media="(max-width: 640px)" type="image/webp"><source srcset="images/gallery/1024w/b20x_1024w.webp" media="(max-width: 1024px)" type="image/webp"><source srcset="images/gallery/1920w/b20x_1920w.webp" media="(max-width: 1920px)" type="image/webp"><img src="images/gallery/b20x.webp" alt="" loading="lazy" decoding="async" width="425" height="354"></picture></a></li>
                  <li><a data-fancybox="grp" href="images/gallery/b21x.webp"><picture><source srcset="images/gallery/320w/b21x_320w.webp" media="(max-width: 320px)" type="image/webp"><source srcset="images/gallery/640w/b21x_640w.webp" media="(max-width: 640px)" type="image/webp"><source srcset="images/gallery/1024w/b21x_1024w.webp" media="(max-width: 1024px)" type="image/webp"><source srcset="images/gallery/1920w/b21x_1920w.webp" media="(max-width: 1920px)" type="image/webp"><img src="images/gallery/b21x.webp" alt="" loading="lazy" decoding="async" width="425" height="354"></picture></a></li>
                  <li><a data-fancybox="grp" href="images/gallery/b22x.webp"><picture><source srcset="images/gallery/320w/b22x_320w.webp" media="(max-width: 320px)" type="image/webp"><source srcset="images/gallery/640w/b22x_640w.webp" media="(max-width: 640px)" type="image/webp"><source srcset="images/gallery/1024w/b22x_1024w.webp" media="(max-width: 1024px)" type="image/webp"><source srcset="images/gallery/1920w/b22x_1920w.webp" media="(max-width: 1920px)" type="image/webp"><img src="images/gallery/b22x.webp" alt="" loading="lazy" decoding="async" width="425" height="354"></picture></a></li>
                  <li><a data-fancybox="grp" href="images/gallery/b23x.webp"><picture><source srcset="images/gallery/320w/b23x_320w.webp" media="(max-width: 320px)" type="image/webp"><source srcset="images/gallery/640w/b23x_640w.webp" media="(max-width: 640px)" type="image/webp"><source srcset="images/gallery/1024w/b23x_1024w.webp" media="(max-width: 1024px)" type="image/webp"><source srcset="images/gallery/1920w/b23x_1920w.webp" media="(max-width: 1920px)" type="image/webp"><img src="images/gallery/b23x.webp" alt="" loading="lazy" decoding="async" width="425" height="354"></picture></a></li>
                  <li><a data-fancybox="grp" href="images/gallery/b24x.webp"><picture><source srcset="images/gallery/320w/b24x_320w.webp" media="(max-width: 320px)" type="image/webp"><source srcset="images/gallery/640w/b24x_640w.webp" media="(max-width: 640px)" type="image/webp"><source srcset="images/gallery/1024w/b24x_1024w.webp" media="(max-width: 1024px)" type="image/webp"><source srcset="images/gallery/1920w/b24x_1920w.webp" media="(max-width: 1920px)" type="image/webp"><img src="images/gallery/b24x.webp" alt="" loading="lazy" decoding="async" width="425" height="354"></picture></a></li>
                  <li><a data-fancybox="grp" href="images/gallery/b25x.webp"><picture><source srcset="images/gallery/320w/b25x_320w.webp" media="(max-width: 320px)" type="image/webp"><source srcset="images/gallery/640w/b25x_640w.webp" media="(max-width: 640px)" type="image/webp"><source srcset="images/gallery/1024w/b25x_1024w.webp" media="(max-width: 1024px)" type="image/webp"><source srcset="images/gallery/1920w/b25x_1920w.webp" media="(max-width: 1920px)" type="image/webp"><img src="images/gallery/b25x.webp" alt="" loading="lazy" decoding="async" width="425" height="354"></picture></a></li>
                  <li><a data-fancybox="grp" href="images/gallery/b26x.webp"><picture><source srcset="images/gallery/320w/b26x_320w.webp" media="(max-width: 320px)" type="image/webp"><source srcset="images/gallery/640w/b26x_640w.webp" media="(max-width: 640px)" type="image/webp"><source srcset="images/gallery/1024w/b26x_1024w.webp" media="(max-width: 1024px)" type="image/webp"><source srcset="images/gallery/1920w/b26x_1920w.webp" media="(max-width: 1920px)" type="image/webp"><img src="images/gallery/b26x.webp" alt="" loading="lazy" decoding="async" width="425" height="354"></picture></a></li>
                  <li><a data-fancybox="grp" href="images/gallery/b27x.webp"><picture><source srcset="images/gallery/320w/b27x_320w.webp" media="(max-width: 320px)" type="image/webp"><source srcset="images/gallery/640w/b27x_640w.webp" media="(max-width: 640px)" type="image/webp"><source srcset="images/gallery/1024w/b27x_1024w.webp" media="(max-width: 1024px)" type="image/webp"><source srcset="images/gallery/1920w/b27x_1920w.webp" media="(max-width: 1920px)" type="image/webp"><img src="images/gallery/b27x.webp" alt="" loading="lazy" decoding="async" width="425" height="354"></picture></a></li>
               </ul>
            </div>
         </section>
            ...
            <div class="container">
               <div class="row">
                  ...
                  <div id="contactUs" class="col-12 col-md-6">
                     <form class="pp-3" action="mail-files/mail.php" method="POST">
